...
<body>
    ...
    <main>
        ...
        <div class="container">
            ...
            <h3>Zombis</h3>
            <a id="addzombie" class="right btn-floating btn-large waves-effect waves-light red"><i class="material-icons">add</i></a>
            <div class="row">
                <div class="col s12 m6">
                    <div class="card  light-blue lighten-1">
                        <div  class="card-content">
                            <span class="card-title">Registro de Zombie</span>
                            <div class="input-field col s6 grey lighten-5" >
                                <input placeholder="Royer" id="nombrezombie" type="text" >
                        ...
                        <div class="card-action">
                            <button  id="enviarzombi" class="btn waves-effect waves-light"  name="action">
