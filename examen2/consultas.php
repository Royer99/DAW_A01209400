...
<body>
    ...
    <main>
        ...
        <div class="container">
        <h3>1. Todos los registros de zombis con todas las actualizaciones de cada uno.</h3>
        <table class="highlight">
            ...
            <h3>2. La cantidad total de zombis registrados, y la cantidad de zombis en cada estado.</h3>
            <div id="consulta2"></div>
            <h3>3. Todos los registros de actualización de estado de zombis del más reciente al más antiguo por la fecha de su registro.</h3>
            <div id="consulta3"></div>
            <h3>4. Los registros de zombis con el estado elegido por el usuario y la cantidad de ellos.</h3>
            <div id="consulta4"></div>
        </div>
    </main>
